      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 px-5 py-6">
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3 py-2">
            ...
            <span className="text-xs text-gray-400 font-medium tracking-wide uppercase">or log in with email</span>
            <div className="flex-1 h-px bg-gray-200" />
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-red-700 hover:bg-red-800 disabled:bg-red-300 text-white font-bold py-4 rounded-xl transition-colors text-base tracking-wide"
            >
