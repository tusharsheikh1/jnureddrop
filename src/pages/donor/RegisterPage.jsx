        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 px-5 py-6">
          <div className="space-y-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Register button */}
              <button type="submit" disabled={loading} className="w-full bg-red-700 hover:bg-red-800 disabled:bg-red-300 text-white font-bold py-4 rounded-xl transition-colors text-base tracking-wide mt-2">
